...
public class TrainModel {
  public static void main(String[] args) throws IOException {
    ...
    String corpus = "offensive-qc"; // "clef" OR "fire-new";
...
//    String useDict = "data/"+corpus+"/"+lang.getCode()+"/dict-word-hash.txt";
    String useDict = "";
    ...
    String file = "data/data-train.dat";
    String posFile = "data/pos-data-train.dat";
    String negFile = "data/neg-data-train.dat";

    // TEST- Use no more than 500 samples
    String test_file = "data/data-test-part.dat";
    String test_posFile = "data/pos-data-test-part.dat";
    String test_negFile = "data/neg-data-test-part.dat";
...
/*      Layer l2 = new TanhLayer(128);
      ...
      // wrightScale and biasScale
      enModel.init(0.01, -0.05);
